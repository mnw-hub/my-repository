...
app = Flask(__name__)
  ...
  #render template is used to pass the number to the html file ; jinja is used to interface with python

@app.route("/")
def head(): 
    return render_template("index.html", number1=10, number2=20)
    
   #the 2 <> allow us to control the web page with input from user 
